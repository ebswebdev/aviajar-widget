            ...
            const e = s.value.trim(); t && clearTimeout(t), l.innerHTML = "", e.length < 3 ? c && (c.innerHTML = "") : t = setTimeout(() => {
                GetOptionsFromServer(e, a, o, i, r, function (e) {
                    var t; e && (l.innerHTML = "", t = e.Locations || e.locations || [], e = e.Hotels || e.hotels || [], [...t, ...e].forEach(e => {
                        const t = void 0 !== e.Name, n = t ? e.Name : e.hotel_name; var a = t ? e.NameFull || "" : e.address || ""; const o = e.Id || e.id; var e = t ? "fas fa-map-marker-alt" : "fas fa-bed", i = document.createElement("div"); i.className = "autocomplete-item", i.innerHTML = `
