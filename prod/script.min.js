...
} function generateURLPaquetes() { var t = document.getElementById("widget-container"), n = document.getElementById("widget-net"); if (t) { var t = n.getAttribute("culture") || "es-CO", r = n.getAttribute("host") || "https://reservas.aviajarcolombia.com/", s = n.getAttribute("productType") || "Package", l = n.getAttribute("userService") || "aviajar", n = n.getAttribute("branchCode") || "003", c = document.querySelector("#origen-id")?.value || "", d = document.querySelector("#destino-id")?.value || "", u = document.querySelector("#fecha-rango")?.value || ""; let e = []; u.includes(" al ") ? e = u.split(" al ") : u.includes(" to ") ? e = u.split(" to ") : u && (e = [u, u]); var p = e[0]?.trim() || "", m = e[1]?.trim() || p, v = document.querySelector("#num-hab")?.value || "1", f = document.querySelector("#checkbox-vequipaje")?.checked ? "true" : "false", h = document.querySelector("#checkbox-vdirecto")?.checked ? "true" : "false", y = document.querySelector("#codigo-descuento")?.value || ""; console.log("Debug Paquetes - Valores obtenidos:"), console.log("cityFrom:", c), console.log("cityTo:", d), console.log("fechaRangoRaw:", u), console.log("dateFrom:", p), console.log("dateTo:", m); let a = [], o = 0, i = 0; document.querySelectorAll("#hab-container > div").forEach(e => { var t = parseInt(e.querySelector("#numeric-value-adultos")?.value || "1"), n = parseInt(e.querySelector("#numeric-value-ninos")?.value || "0"), e = Array.from(e.querySelectorAll(".edad-nino")).map(e => e.value || "0").join("-"); o += t, i += n, 0 < n ? a.push(t + "-" + e) : a.push("" + t) }); u = a.join("!"); return c && d && p && m ? (r = "" + r + t + `/${s}/${c}/${d}/${p}/${m}/${o}/${v}/0/${p}/${m}/${u}/${f}/${h}/NA/Economy/NA/${l}--` + n + (y ? "-----" + y : "-----"), console.log("Generated URL:", r), r) : (console.error("Faltan parámetros obligatorios para generar la URL."), null) } } function botonBusquedaPaquetes() { document.getElementById("widget-container") && (document.querySelector("#buscar-btn-paquetes").addEventListener("click", function (e) { e.preventDefault(); let t = !0; var e = document.querySelector("#origen"), n = document.querySelector("#destino"), a = document.querySelector("#fecha-rango"), o = document.querySelector("#origen-id"), i = document.querySelector("#destino-id"); if (15 < (parseInt(document.querySelector("#num-per")?.value) || 0)) { const l = document.querySelector("#modal-error"); l.style.display = "block", setTimeout(() => { document.addEventListener("click", function e(t) { document.querySelector(".modal-content").contains(t.target) || (l.style.display = "none", document.removeEventListener("click", e)) }) }, 100) } function r(e) { e.classList.add("input-error") } function s(e) { e.classList.remove("input-error") } o && o.value ? s(e) : (r(e), t = !1), i && i.value ? s(n) : (r(n), t = !1), a.value ? s(a) : (r(a), t = !1), t && t && ((o = generateURLPaquetes()) ? (console.log("Redirigiendo a:", o), window.location.href = o) : (console.error("No se pudo generar la URL de paquetes"), alert("Error: No se pudo generar la URL. Verifica que todos los campos estén completos."))) }), document.querySelector("#origen").addEventListener("input", function () { this.classList.remove("input-error") }), document.querySelector("#destino").addEventListener("input", function () { this.classList.remove("input-error") }), document.querySelector("#fecha-rango").addEventListener("change", function () { this.classList.remove("input-error") }), document.querySelector("#fecha-rango").addEventListener("change", function () { document.querySelector("#fecha-rango").value.includes("to") && (document.querySelector("#fecha-rango").value = document.querySelector("#fecha-rango").value.replace("to", "al")) })) } function crearPopupVuelos() {
    if (document.getElementById("widget-container")) {
