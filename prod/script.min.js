function inicializarDescuento() { var e = document.querySelector("#mostrar-descuento"); const t = document.querySelector(".descuento"); e && t && e.addEventListener("click", function (e) { e.preventDefault(), "none" === t.style.display || "" === t.style.display ? t.style.display = "block" : t.style.display = "none" }) } function cargarEstilosSegunContenedor() { var e; document.querySelector("#widget-net") ? (e = document.querySelector("#dynamic-styles")) && "styles.min.css" === e.getAttribute("href") || (e && e.remove(), (e = document.createElement("link")).id = "dynamic-styles", e.rel = "stylesheet", e.href = "https://aviajarcolombia.com/widget3.0/styles.min.css", document.head.appendChild(e), console.log("Cargado: styles.min.css")) : console.error("No se encontró el widget.") } !function () {
            ...
            var e = u.getAttribute("products")?.replace(/[\[\]\s]/g, "").split(",") || []; console.log(e); const n = { AirHotel: { id: "paquetes", icon: "fa-suitcase", img: "https://aviajarcolombia.com/wp-content/uploads/2025/06/HOTEL.png", text: "Paquetes" }, Air: { id: "vuelos", icon: "fa-plane", img: "https://aviajarcolombia.com/wp-content/uploads/2025/06/VUELOS.png", text: "Vuelos" }, Hotel: { id: "hoteles", icon: "fa-h-square", img: "https://aviajarcolombia.com/wp-content/uploads/2025/06/HOTEL-1.png", text: "Hoteles" }, Autos: { id: "autos", icon: "fa-car", img: "https://aviajarcolombia.com/wp-content/uploads/2025/06/AUTOS.png", text: "Autos" }, Extras: { id: "tours", icon: "fa-ticket-alt", img: "https://aviajarcolombia.com/wp-content/uploads/2025/06/EXTRAS.png", text: "Tours" } }; var t = document.createElement("div"); t.className = "tabs", t.innerHTML = e.filter(e => n[e]).map(e => {
                e = n[e] || {}; return `
                    <div class="tab" id="tab-${e.id}">
                        <img src="${e.img}" alt="${e.text}" class="tab-icon">
    ...
    if (document.getElementById("widget-container")) {
        const i = document.querySelector("#num-hab"); var e = document.querySelector("#popup-num-hab"); const r = document.querySelector("#hab-popup"), m = document.querySelector("#hab-container"); if (i && e && r && m) {
            i.parentElement.style.position = "relative", i.addEventListener("click", function () { r.style.display = "flex", r.classList.toggle("active") }), document.querySelector("#accept-popup")?.addEventListener("click", function () { let n = 0, a = 0; document.querySelectorAll("#hab-container > div").forEach(e => { var t = parseInt(e.querySelector(".input-adultos input")?.value) || 0, e = parseInt(e.querySelector(".input-ninos input")?.value) || 0; n += t, a += e }), document.querySelector("#num-per").value = n + a, r.classList.remove("active"), r.style.display = "none" }); document.querySelector("#num-per")?.addEventListener("click", function () { r.style.display = "flex" }), o(1), i.addEventListener("input", function () { o(parseInt(i.value) || 1) }); var t = document.createElement("div"), n = (t.className = "numeric-input", document.createElement("button")); n.className = "decrement", n.textContent = "-"; const s = document.createElement("input"); s.type = "number", s.id = "numeric-value", s.value = "1", s.min = "1", s.max = "4", s.readOnly = !0; var a = document.createElement("button"); function o(t) {
                m.innerHTML = ""; const i = document.getElementById("widget-net")?.getAttribute("language")?.substring(0, 2) || "es"; for (let e = 1; e <= t; e++) {
...
} function generateURLVuelos() { var e = document.getElementById("widget-net"), t = e.getAttribute("culture") || "es-CO", n = e.getAttribute("host") || "https://reservas.aviajarcolombia.com/", a = e.getAttribute("productType") || "Air", o = e.getAttribute("userService") || "aviajar", e = e.getAttribute("branchCode") || "003", i = document.querySelector("#radio-multidestino")?.checked, r = parseInt(document.querySelector("#numeric-value-adultos")?.value) || 1, s = parseInt(document.querySelector("#numeric-value-ninos")?.value) || 0, l = parseInt(document.querySelector("#numeric-value-infantes")?.value) || 0, c = document.querySelector("#checkbox-vequipaje")?.checked ? "true" : "false", d = document.querySelector("#checkbox-vdirecto")?.checked ? "true" : "false", u = document.querySelector("#codigo-descuento")?.value || ""; if (i) { i = Array.from(document.querySelectorAll(".tramo")); if (i.length < 2) return alert("Debes agregar al menos dos tramos para multidestino."), null; var p = [], m = [], v = []; for (const L of i) { var f = L.querySelector("select.input-tramo-origen-id"), y = L.querySelector("select.input-tramo-destino-id"), h = L.querySelector(".input-tramo-fecha"), f = f?.value || "", y = y?.value || "", h = h?.value.trim(); if (!f || !y || !h) return alert("Completa todos los campos de cada tramo."), null; p.push(f), m.push(y), v.push(h) } const q = "" + n + t + `/${a}/MD/${p.join(",")}/${m.join(",")}/${v.join(",")}/${r}/${s}/${l}/${c}/${d}/NA/NA/NA/${o}-show-${e}---------${u}#air`; return console.log("Generated URL (MD):", q), q } var i = document.querySelector("#radio-soloida")?.checked ? "OW" : "RT", g = document.querySelector("#origen-id")?.value || "", b = document.querySelector("#destino-id")?.value || "", S = document.querySelector("#fecha-rango")?.value.split(" to ") || [], E = S[0] || "", S = "RT" == i && S[1] || ""; if (console.log("cityFrom:", g), console.log("cityTo:", b), console.log("dateFrom:", E), console.log("dateTo:", S), !g || !b || !E || "RT" == i && !S) return console.error("Faltan parámetros obligatorios para generar la URL."), null; const q = "" + n + t + `/${a}/${i}/${g}/${b}/${E}/${S}/${r}/${s}/${l}/NA/NA/NA/NA/NA/${c}/${d}/${o}-show-${e}---------${u}#air`; return console.log("Generated URL:", q), q } function botonBusquedaVuelos() { var e; document.getElementById("widget-container") && (document.querySelector("#buscar-btn-vuelos").addEventListener("click", function (e) { e.preventDefault(); let t = !0; var e = document.querySelector("#origen"), n = document.querySelector("#destino"), a = document.querySelector("#fecha-rango"), o = document.querySelector("#origen-id"), i = document.querySelector("#destino-id"); function r(e) { e && e.classList.add("input-error") } function s(e) { e && e.classList.remove("input-error") } document.querySelector("#radio-multidestino")?.checked || (o && o.value ? s(e) : (r(e), t = !1), i && i.value ? s(n) : (r(n), t = !1), a && a.value ? s(a) : (r(a), t = !1)), t && ((o = generateURLVuelos()) ? (console.log(o), window.location.href = o, document.querySelectorAll("#origen-id, #destino-id").forEach(e => { e.querySelector("option[selected]") || (e.innerHTML = "") }), e && (e.value = ""), n && (n.value = ""), a && (a.value = "")) : alert("Por favor completa todos los campos obligatorios.")) }), (e = document.querySelector("#origen")) && e.addEventListener("input", function () { this.classList.remove("input-error") }), (e = document.querySelector("#destino")) && e.addEventListener("input", function () { this.classList.remove("input-error") }), (e = document.querySelector("#fecha-rango")) && e.addEventListener("change", function () { this.classList.remove("input-error") }), setupFlatpickrEvents(), inicializarFlatpickrVuelos()) } function ajustarWidget() { var e, t, n = document.querySelector(".contenedor-widget"); n && (e = 1024 <= window.innerWidth, t = n.offsetWidth < 1e3, n.classList.toggle("widget-ajustado", e && t)) } function inicializarFlatpickrVuelos() { const n = document.querySelector("#fecha-rango"); if (n && "undefined" != typeof flatpickr) { n._flatpickr && n._flatpickr.destroy(); var e = document.getElementById("widget-net")?.getAttribute("language")?.substring(0, 2) || "es", e = (translations[e] || translations.es).flatpickr || {}; const a = document.querySelector("#radio-soloida")?.checked; var t = window.innerWidth <= 768; flatpickr("#fecha-rango", { mode: a ? "single" : "range", dateFormat: "Y-m-d", minDate: "today", showMonths: t ? 1 : 2, disableMobile: !0, locale: { weekdays: { shorthand: e.weekdays?.shorthand || ["Do", "Lu", "Ma", "Mi", "Ju", "Vi", "Sa"], longhand: e.weekdays?.longhand || ["Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"] }, months: { shorthand: e.months?.shorthand || ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"], longhand: e.months?.longhand || ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"] } }, onClose: function (e) { var t; 0 < e.length && (t = (t = e[0]).getFullYear() + "-" + String(t.getMonth() + 1).padStart(2, "0") + "-" + String(t.getDate()).padStart(2, "0"), a ? n.value = t : 2 === e.length && (e = (e = e[1]).getFullYear() + "-" + String(e.getMonth() + 1).padStart(2, "0") + "-" + String(e.getDate()).padStart(2, "0"), n.value = t + " to " + e)) } }), n.setAttribute("type", "text"), n.setAttribute("placeholder", a ? e.placeholderIda || "Selecciona la fecha de ida" : e.placeholderRango || "Selecciona un rango de fechas") } } function setupFlatpickrEvents() { var e = document.querySelector("#radio-soloida"), t = document.querySelector("#radio-idayregreso"); e && e.addEventListener("change", inicializarFlatpickrVuelos), t && t.addEventListener("change", inicializarFlatpickrVuelos) } function autocompleteHotelesCiudadesAPI(e, t, n, o, i, r) {
    const s = document.querySelector(e), l = document.querySelector(t), c = document.querySelector(n); s.addEventListener("input", function () {
        const a = s.value.trim(); var e; l.innerHTML = "", a.length < 3 ? c && (c.innerHTML = "") : (e = o + "?searchCriteria=" + encodeURIComponent(a) + "&userServices=" + i + "&lang=" + r, console.log("URL de la API:", e), console.log("Parámetros:", { query: a, userServices: i, lang: r }), fetch(e).then(e => (console.log("Status HTTP:", e.status, e.statusText), e.json())).then(e => {
            console.log("Respuesta API hoteles:", e), console.log("Tipo de respuesta:", Array.isArray(e) ? "Array" : "Objeto"), Array.isArray(e) && 0 < e.length && (console.log("Primera entrada del array:", e[0]), console.log("Propiedades disponibles:", Object.keys(e[0]))); let t = []; var n; 0 === (t = Array.isArray(e) ? e.map(e => { let t = e.Name || e.hotel_name; return { name: t = (t = !t && "point_of_interest" === e.Type && e.NearestIataCode ? e.NearestIataCode : t) || e.Id || "Sin nombre", subtitle: e.NameFull || e.address || e.NearestIataCode || e.Type || "", type: e.Type || "location", id: e.Id } }) : (n = (e.Hotels || e.hotels || []).map(e => ({ name: e.hotel_name || e.Name || e.Id || "Sin nombre", subtitle: e.address || "", type: "hotel", id: e.Id })), (e.Locations || e.locations || []).map(e => ({ name: e.Name || e.Id || "Sin nombre", subtitle: e.NameFull || "", type: "ciudad", id: e.Id })).concat(n))).length ? console.log("No se encontraron resultados para:", a) : t.forEach(n => {
                var e = document.createElement("div"); e.className = "autocomplete-item-hoteles", e.innerHTML = `
                    ...
                    `, e.addEventListener("click", function () { s.value = n.name + (n.subtitle ? ", " + n.subtitle : ""), l.innerHTML = ""; var e, t = ("hotel" === n.type ? "h" : "l") + n.id; c && (c.innerHTML = "", (e = document.createElement("option")).value = t, e.selected = !0, c.appendChild(e), c.setAttribute("data-tipo", n.type)), console.log("Seleccionado:", s.value, "Código:", t, "Tipo:", n.type), console.log(n.name + (n.subtitle ? ", " + n.subtitle : ""), "ID:", n.id) }), l.appendChild(e)
            })
        }).catch(e => { console.error("Error en el autocomplete de hoteles/ciudades:", e) }))
    }), document.addEventListener("click", function (e) { l && !l.contains(e.target) && e.target !== s && (l.innerHTML = "") })
    ...
    if (document.getElementById("widget-container")) {
        const i = document.querySelector("#num-hab"); var e = document.querySelector("#popup-num-hab"); const r = document.querySelector("#hab-popup"), p = document.querySelector("#hab-container"); if (i && e && r && p) {
            i.parentElement.style.position = "relative", i.addEventListener("click", function () { r.style.display = "flex", r.classList.toggle("active") }), document.querySelector("#accept-popup")?.addEventListener("click", function () { let n = 0, a = 0; document.querySelectorAll("#hab-container > div").forEach(e => { var t = parseInt(e.querySelector(".input-adultos input")?.value) || 0, e = parseInt(e.querySelector(".input-ninos input")?.value) || 0; n += t, a += e }), document.querySelector("#num-per").value = n + a, r.classList.remove("active"), r.style.display = "none" }); document.querySelector("#num-per")?.addEventListener("click", function () { r.style.display = "flex" }), o(1), i.addEventListener("input", function () { o(parseInt(i.value) || 1) }); var t = document.createElement("div"), n = (t.className = "numeric-input", document.createElement("button")); n.className = "decrement", n.textContent = "-"; const s = document.createElement("input"); s.type = "number", s.id = "numeric-value", s.value = "1", s.min = "1", s.max = "4", s.readOnly = !0; var a = document.createElement("button"); function o(t) {
            ...
            `, p.appendChild(n), n.querySelector(".input-adultos")), o = (a.innerHTML = "", n.querySelector(".input-ninos")), i = (o.innerHTML = "", document.createElement("div")), r = (i.className = "numeric-input", document.createElement("button")); r.className = "decrement", r.textContent = "-"; const c = document.createElement("input"); c.type = "number", c.value = "2", c.min = "1", c.max = "7", c.readOnly = !0; var s = document.createElement("button"), a = (s.className = "increment", s.textContent = "+", i.appendChild(r), i.appendChild(c), i.appendChild(s), a.appendChild(i), document.createElement("div")), i = (a.className = "numeric-input", document.createElement("button")); i.className = "decrement", i.textContent = "-"; const d = document.createElement("input"); d.type = "number", d.value = "0", d.min = "0", d.max = "4", d.readOnly = !0; var l = document.createElement("button"); l.className = "increment", l.textContent = "+", a.appendChild(i), a.appendChild(d), a.appendChild(l), o.appendChild(a); const u = n.querySelector("#edades-ninos"); d.addEventListener("input", function () { var t = parseInt(d.value) || 0; u.innerHTML = ""; for (let e = 1; e <= t; e++) { var n = document.createElement("label"), a = (n.textContent = `Edad del niño ${e}:`, document.createElement("select")); a.className = "edad-nino", a.name = "edad-nino-" + e; for (let e = 1; e <= 12; e++) { var o = document.createElement("option"); o.value = e, o.textContent = e, a.appendChild(o) } u.appendChild(n), u.appendChild(a) } }), r.addEventListener("click", function () { var e = parseInt(c.value) || 1; e > parseInt(c.min) && (c.value = e - 1) }), s.addEventListener("click", function () { var e = parseInt(c.value) || 1; e < parseInt(c.max) && (c.value = e + 1) }), i.addEventListener("click", function () { var e = parseInt(d.value) || 0; e > parseInt(d.min) && (d.value = e - 1, d.dispatchEvent(new Event("input"))) }), l.addEventListener("click", function () { var e = parseInt(d.value) || 0; e < parseInt(d.max) && (d.value = e + 1, d.dispatchEvent(new Event("input"))) })
                }
